...
const AdminForm = ({ onSuccess }) => {
  ...
  if (loading) {
    return (
      <div className="text-center mt-8 text-gray-600">Loading form...</div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            readOnly
            className="w-full border border-gray-500 rounded px-3 py-2 bg-gray-100"
          />
        </div>
        <div className="md:col-span-2">
        ...
        <div className="md:col-span-2">
          <label htmlFor="shopUrl" className="block text-gray-700 mb-1">
            Shop URL *
          </label>
          <input
            id="shopUrl"
