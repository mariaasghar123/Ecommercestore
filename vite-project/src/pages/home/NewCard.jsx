...
const offers = [
  {
    ...
    img: "/media/images/banner-08.jpg.png", // ✅ Public folder access
  },
  {
    label: "Only This Week",
    heading: "Snacks that nourishes our mind and body",
    desc: "Shine the morning...",
    img: "/media/images/banner-09.jpg.png",
  },
];

export default function NewCard() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5 w-11/12 md:w-3/4 mx-auto mt-5">
