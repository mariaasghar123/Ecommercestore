        ...
        <Router>
          <Layout>
            <Routes>
              ...
              />
              <Route
                path="/admin/admin-dashboard/add-product"
                element={
                  <ProtectedRouteForAdmin>
                    Dashboard
                    <AddProductPage />
              ...
              />
              <Route
                path="/admin/admin-dashboard/alluseraccounts"
                element={
                  <ProtectedRouteForAdmin>
                    <AllUserAccounts />
                  </ProtectedRouteForAdmin>
              ...
              />
              <Route
                path="/admin/admin-dashboard/products"
                element={
                  <ProtectedRouteForAdmin>
                    <ProductListPage />
                  </ProtectedRouteForAdmin>
              ...
              />
              <Route
                path="/admin/admin-dashboard/edit-product/:id"
                element={
                  <ProtectedRouteForAdmin>
                    <EditProduct />
                  </ProtectedRouteForAdmin>
              ...
              />
              <Route
                path="/admin/admin-dashboard/view-product/:id"
                element={
                  <ProtectedRouteForAdmin>
                    <ViewProduct />
                  </ProtectedRouteForAdmin>
              ...
              />
              <Route
                path="/admin/admin-dashboard/orders"
                element={
                  <ProtectedRouteForAdmin>
                    <AdminOrders />
                  </ProtectedRouteForAdmin>
