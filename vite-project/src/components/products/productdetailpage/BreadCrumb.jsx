...
const Breadcrumb = () => {
  ...
  // agar location path sirf '/' hai to kuch render na karo
  ...
  return (
    <nav className="text-sm text-gray-500 max-w-7xl mb-4 mt-2 px-6">
      <ol className="list-reset flex flex-wrap items-center">
        <li>
          <Link to="/" className="text-gray-600 max-w-7xl hover:underline">Home</Link>
        </li>
        {crumbs.map((crumb, index) => (
          <React.Fragment key={index}>
            <li><span className="mx-2"><IoIosArrowForward />
              </span></li>
            <li>
